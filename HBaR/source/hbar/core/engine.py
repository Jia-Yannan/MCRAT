...
def training_standard(config_dict):
    ...
    for cepoch in range(1, nepoch+1):
        ...
        print(f"Epoch {cepoch}: Current learning rate is {current_lr}")
        ...
        train_loss, train_acc, train_hx, train_hy = misc.get_hsic_epoch(config_dict, model, train_loader, n_classes)
        test_loss, test_acc, test_hx, test_hy = misc.get_hsic_epoch(config_dict, model, test_loader, n_classes)
